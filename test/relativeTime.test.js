...
test("should show relative time +ve part", () => {
  expect(duration.relativeTime(Date.now() + 1000)).toBe("in a few seconds");
  expect(duration.relativeTime(Date.now() + 1000 * 60)).toBe("in a minute");
  expect(duration.relativeTime(Date.now() + 1000 * 60 * 60)).toBe("in an hour");
  expect(duration.relativeTime(Date.now() + 1000 * 60 * 60 * 5)).toBe(
    "in 5 hours"
  );
  expect(duration.relativeTime(Date.now() + 1000 * 60 * 60 * 24)).toBe(
    "tomorrow"
  ...
  expect(
    duration.relativeTime(Date.now() + 1000 * 60 * 60 * 24 * 7 * 4 * 12)
  ).toBe("in 11 months");
  expect(
    duration.relativeTime(Date.now() + 1000 * 60 * 60 * 24 * 7 * 4 * 12 * 2)
  ).toBe("in a year");
  expect(
    duration.relativeTime(Date.now() + 1000 * 60 * 60 * 24 * 7 * 4 * 12 * 2 * 3)
  ).toBe("in 5 years");
  expect(
    duration.relativeTime(
      Date.now() + 1000 * 60 * 60 * 24 * 7 * 4 * 12 * 2 * 3 * 4
    )
  ).toBe("in 22 years");
});
